function showTime() { 
	...
	var startDate = new Date(2024, 02, 12);// 注意月份索引从 0 开始，所以 3 月是 2
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "我的挚爱倩倩:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----代江林   2024-05-04</c>"; 
